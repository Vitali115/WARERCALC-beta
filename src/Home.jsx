  ...
  return (
    <div className="screen">
      ...
      <div className="home-card">
        ...
        <button onClick={goToScreen2zero}>Inizia</button>
      </div>
      <hr />
      <div className="home-card">
        <div className="home-card-body">
          ...
          {/* <img src="https://svgur.com/i/ueN.svg" /> */}
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="app">
            ...
            {currentScreen === 3 && <Screen3 goToScreen1={goToScreen1} />}
            {/*  */}
            {currentScreen === 4 && <Screen2 goToScreen1={goToScreen1} />}
            {currentScreen === 5 && <Screen2uno goToScreen1={goToScreen1} />}
            {currentScreen === 6 && <Screen2due goToScreen1={goToScreen1} />}
          </div>
        </>
      )}
    </div>
